...
def get_system_prompt(
    ...
    system = (
        ...
        "CRITICAL: The 'slides' array MUST contain EXACTLY the number given in "
        "'Number of Slides' — never fewer, never more. If you are unsure, add brief "
        "slides to reach the exact count.\n"
        ...
        "Make sure data is consistent across all slides. Output must be valid json-compatible data.\n"
    )
